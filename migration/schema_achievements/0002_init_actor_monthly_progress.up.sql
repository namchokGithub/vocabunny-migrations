...
CREATE TABLE tbl_actor_monthly_progress (
...
CREATE INDEX idx_tbl_actor_monthly_progress_month_key ON tbl_actor_monthly_progress (month_key);
CREATE INDEX idx_tbl_actor_monthly_progress_deleted_at ON tbl_actor_monthly_progress (deleted_at);
