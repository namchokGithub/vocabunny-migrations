...
CREATE TABLE tbl_actor_trophies (
...
CREATE INDEX idx_tbl_actor_trophies_actor_id_awarded_at ON tbl_actor_trophies (actor_id, awarded_at);
CREATE INDEX idx_tbl_actor_trophies_deleted_at ON tbl_actor_trophies (deleted_at);
