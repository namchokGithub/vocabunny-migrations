...
CREATE INDEX idx_tbl_trophy_tiers_code ON tbl_trophy_tiers (code);
CREATE INDEX idx_tbl_trophy_tiers_is_active ON tbl_trophy_tiers (is_active);
CREATE INDEX idx_tbl_trophy_tiers_deleted_at ON tbl_trophy_tiers (deleted_at);
