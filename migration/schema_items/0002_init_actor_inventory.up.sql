...
CREATE TABLE tbl_actor_inventory (
...
CREATE INDEX idx_tbl_actor_inventory_item_id ON tbl_actor_inventory (item_id);
CREATE INDEX idx_tbl_actor_inventory_deleted_at ON tbl_actor_inventory (deleted_at);
