...
CREATE INDEX idx_tbl_shop_orders_actor_id_created_at ON tbl_shop_orders (actor_id, created_at);
CREATE INDEX idx_tbl_shop_orders_status ON tbl_shop_orders (status);
CREATE INDEX idx_tbl_shop_orders_deleted_at ON tbl_shop_orders (deleted_at);
