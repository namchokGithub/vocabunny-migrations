...
CREATE INDEX idx_tbl_leaderboard_weekly_week_key_weekly_exp_updated_at ON tbl_leaderboard_weekly (week_key, weekly_exp, updated_at);
CREATE INDEX idx_tbl_leaderboard_weekly_deleted_at ON tbl_leaderboard_weekly (deleted_at);
